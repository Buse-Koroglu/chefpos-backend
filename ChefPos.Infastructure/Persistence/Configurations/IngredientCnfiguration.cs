...
public class IngredientConfiguration : IEntityTypeConfiguration<Ingredient>
{
    public void Configure(EntityTypeBuilder<Ingredient> builder)
    {
        ...
        // Aynı lokasyonda aynı isimde iki hammadde olmamalı
        builder.HasIndex(i => new { i.LocationId, i.Name }).IsUnique();

        builder.ToTable(i => i.HasCheckConstraint("CK_Ingredient_CurrentStock_NonNegative", "\"CurrentStock\" >= 0"));
        builder.ToTable(i => i.HasCheckConstraint("CK_Ingredient_UnitPrice_NonNegative", "\"UnitPrice\" >= 0"));
