...
public class ActivateIngredientCommandHandler : IRequestHandler<ActivateIngredientCommand, IngredientResponseDto>
{
    ...
    public ActivateIngredientCommandHandler(IIngredientRepository ingredientRepository, IUserRepository userRepository, ICurrentUserService currentUserService)
    {
